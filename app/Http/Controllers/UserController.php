...
class UserController extends Controller
{
  ...
  public function relacionesFamiliares(User $usuario)
  {
  ...
  public function eliminarRelacionFamiliar(ParienteUsuario $pariente)
  {
    ...
    return redirect()->route('usuario.relacionesFamiliares',$usuarioSeleccioanado)->with('success', " El tema fue eliminado  con éxito.");
  }
