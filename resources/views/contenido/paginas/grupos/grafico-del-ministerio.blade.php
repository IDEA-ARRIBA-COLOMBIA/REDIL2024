    ...
    <div class="card h-100 w-100 bg-white">
        <div class="card-header align-items-center">
          ...
          <div class="">
              ...
              <button class="my-1 btn btn-xs btn-outline-primary waves-effect" type="button"   id="btn-UD" value="Up-Down"><span class="ti-xs ti ti-arrow-down-rhombus me-2"></span>De arriba hacia abajo</button>
              <button class="my-1 btn btn-xs btn-outline-primary waves-effect" type="button"   id="btn-DU" value="Down-Up"><span class="ti-xs ti ti-arrow-up-rhombus me-2"></span> De abajo hacia arriba</button>
              <button class="my-1 btn btn-xs btn-outline-primary waves-effect" type="button"   id="btn-LR" value="Left-Right"> <span class="ti-xs ti ti-arrow-right-rhombus me-2"></span> De izquierda a derecha </button>
              <button class="my-1 btn btn-xs btn-outline-primary waves-effect" type="button"   id="btn-RL" value="Right-Left"><span class="ti-xs ti ti-arrow-left-rhombus me-2"></span>De derecha a izquierda </button>
              <button style="display:none !important" class="my-1 btn btn-xs btn-outline-primary waves-effect" type="button"  id="direction" value="LR"> </button>
