        ...
        <div class="flex-grow-1 mt-3 mt-sm-5">
          <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
            <div class="user-profile-info">
              <h4 class="mb-2 mt-lg-6">{{ $usuario->nombre(3) }}</h4>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4 justify-content-center gap-2 gap-lg-0">
      <li class="nav-item"><a id="tap-principal" href="javascript:void(0);" class="tapControl nav-link waves-effect waves-light active" data-tap="principal"><i class='ti-xs ti ti-user-check me-1'></i> Principal</a></li>
      <li class="nav-item"><a id="tap-familia" href="javascript:void(0);" class="tapControl nav-link waves-effect waves-light"  data-tap="familia"><i class='ti-xs ti ti-home-heart me-1'></i> Familia</a></li>
      <li class="nav-item"><a id="tap-congregacion"href="javascript:void(0);" class="tapControl nav-link waves-effect waves-light" data-tap="congregacion"><i class='ti-xs ti ti-building-church me-1'></i> Congregación</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
