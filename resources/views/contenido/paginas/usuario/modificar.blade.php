...
<script type="module">
  ...
  $(".btn-remplazar-archivo").click(function() {
    var archivoR = $(this).data('archivo');
    $("#mensaje_remplazar_" + archivoR).addClass('d-none');
    $("#" + archivoR).removeClass('d-none');
  });
</script>
...
<h4 class="mb-1">{{$formulario->nombre}}</h4>
<p class="mb-4">{{$formulario->descripcion}}</p>

@include('layouts.status-msn')

<form id="formulario" role="form" class="forms-sample" method="POST" action="{{ route($formulario->action, [ 'formulario' => $formulario, 'usuario' => $usuario]) }}" enctype="multipart/form-data">
  @csrf
  @method('PATCH')
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <div class="col-10 offset-1 col-sm-4 offset-sm-4 col-lg-2 offset-lg-5 mb-3">
          <center>
            <img id="preview-foto" class="w-100 cropped-img mt-2 mb-2 rounded-circle" src="{{ Storage::url($configuracion->ruta_almacenamiento.'/img/foto-usuario/'.$usuario->foto) }}" alt="foto perfil">
        ...
        <div class="row">
          <!-- fecha nacimiento -->
          @livewire('Usuarios.formularios.fecha-nacimiento', ['formulario' => $formulario, 'fechaDefault' => $usuario->fecha_nacimiento ? $usuario->fecha_nacimiento : $fechaDefault, 'usuario' => $usuario, ])
          <!-- fecha nacimiento -->
          ...
          <div class="mb-3 {{$formulario->class_tipo_identificacion}}">
            ...
            <select id="tipo_identificacion" name="tipo_identificación" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$tipoIdentificacion->id}}" {{ old('tipo_identificación', $usuario->tipo_identificacion_id )==$tipoIdentificacion->id ? 'selected' : '' }}>{{$tipoIdentificacion->nombre}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_identificacion}}">
            ...
            <input id="identificacion" name="identificación" value="{{ old('identificación', $usuario->identificacion) }}" onkeyup="javascript:this.value=this.value.replace('.', '').replace(' ', '')" type="text" class="form-control" autocomplete="off" />
          ...
          <div class="mb-2 form-group {{$formulario->class_email}}">
            ...
            <div class="input-group input-group-merge">
              <input type="email" id="email" name="email" value="{{ old('email', $usuario->email) }}" onkeyup="javascript:this.value=this.value.toLowerCase()" class="form-control" />
            </div>
          ...
          <div class="mb-2 {{$formulario->class_primer_nombre}}">
            ...
            <input id="primer_nombre" name="primer_nombre" value="{{ old('primer_nombre', $usuario->primer_nombre) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_segundo_nombre}}">
            ...
            <input id="segundo_nombre" name="segundo_nombre" value="{{ old('segundo_nombre', $usuario->segundo_nombre) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_primer_apellido}}">
            ...
            <input id="primer_apellido" name="primer_apellido" value="{{ old('primer_apellido', $usuario->primer_apellido) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_segundo_apellido}}">
            ...
            <input id="segundo_apellido" name="segundo_apellido" value="{{ old('segundo_apellido', $usuario->segundo_apellido) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_genero}}">
            ...
            <select id="genero" name="genero" class="grupoSelect select2 selectorGenero form-select" data-allow-clear="true">
              <option id="genero-m" value="0" {{ old('genero', $usuario->genero)==0 ? 'selected' : '' }}>Masculino</option>
              <option id="genero-f" value="1" {{ old('genero', $usuario->genero)==1 ? 'selected' : '' }}>Femenino</option>
            </select>
          </div>
          @endif
          <!-- /Genero sexual -->
          ...
          <div class="mb-2 {{$formulario->class_estado_civil}}">
            ...
            <select id="estado_civil" name="estado_civil" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$tiposDeEstadoCivil->id}}" {{ old('estado_civil', $usuario->estado_civil_id)==$tiposDeEstadoCivil->id ? 'selected' : '' }}>{{$tiposDeEstadoCivil->nombre}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_pais_nacimiento}}">
            ...
            <select id="pais_nacimiento" name="país" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$pais->id}}" {{ old('país', $usuario->pais_id)==$pais->id ? 'selected' : '' }}>{{ucwords ($pais->nombre)}}</option>
              @endforeach
            </select>
        ...
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_telefono_fijo}}">
            ...
            <div class="input-group input-group-merge">
              ...
              <input id="telefono_fijo" name="teléfono_fijo" value="{{ old('teléfono_fijo', $usuario->telefono_fijo) }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
            </div>
          ...
          <div class="mb-2 {{$formulario->class_telefono_movil}}">
            ...
            <div class="input-group input-group-merge">
              ...
              <input id="telefono_movil" name="teléfono_móvil" value="{{ old('teléfono_móvil', $usuario->telefono_movil) }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
            </div>
          ...
          <div class="mb-2 {{$formulario->class_telefono_otro}}">
            ...
            <div class="input-group input-group-merge">
              <span id="basic-icon-default-phone2" class="input-group-text"><i class="ti ti-phone"></i></span>
              <input id="telefono_otro" name="teléfono_otro" value="{{ old('teléfono_otro', $usuario->telefono_otro) }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
            </div>
          ...
          <div class="mb-2 {{$formulario->class_vivienda_en_calidad_de}}">
            ...
            <select id="vivienda_en_calidad_de" name="tipo_de_vivienda" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$tipoDeVivienda->id}}" {{ old('tipo_de_vivienda', $usuario->tipo_vivienda_id )==$tipoDeVivienda->id ? 'selected' : '' }}>{{ucwords ($tipoDeVivienda->nombre)}}</option>
              @endforeach
            </select>
          ...
          @livewire('Generales.direccion-con-lista-geografica', ['formulario' => $formulario, 'modulo' => 'usuarios', 'usuario' => $usuario])
          @else
          <div class="mb-2 {{$formulario->class_direccion}}">
            ...
            <div class="input-group input-group-merge">
              ...
              <input onkeypress="return sinComillas(event)" id="direccion" name="dirección" value="{{ old('dirección', $usuario->direccion) }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true" placeholder="Digita la dirección, la ciudad y el país, donde vives.">
            </div>
        ...
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_nivel_academico}}">
            ...
            <select id="nivel_academico" name="nivel_académico" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$nivelAcademico->id}}" {{ old('nivel_académico', $usuario->nivel_academico_id)==$nivelAcademico->id ? 'selected' : '' }}>{{ucwords ($nivelAcademico->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_estado_nivel_academico}}">
            ...
            <select id="estado_nivel_academico" name="estado_nivel_académico" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$estadoNivelAcademico->id}}" {{ old('estado_nivel_académico', $usuario->estado_nivel_academico_id)==$estadoNivelAcademico->id ? 'selected' : '' }}>{{ucwords ($estadoNivelAcademico->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_profesion}}">
            ...
            <select id="profesion" name="profesión" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$profesion->id}}" {{ old('profesión', $usuario->profesion_id)==$profesion->id ? 'selected' : '' }}>{{ucwords ($profesion->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_ocupacion}}">
            ...
            <select id="ocupacion" name="ocupación" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$ocupacion->id}}" {{ old('ocupación', $usuario->ocupacion_id)==$ocupacion->id ? 'selected' : '' }}>{{ucwords ($ocupacion->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_sector_economico}}">
            ...
            <select id="sector_economico" name="sector_económico" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$sectorEconomico->id}}" {{ old('sector_económico', $usuario->sector_economico_id)==$sectorEconomico->id ? 'selected' : '' }}>{{ucwords ($sectorEconomico->nombre)}}</option>
              @endforeach
            </select>
        ...
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_tipo_sangre}}">
            ...
            <select id="tipo_sangre" name="tipo_de_sangre" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$tipoSangre->id}}" {{ old('tipo_de_sangre', $usuario->tipo_sangre_id)==$tipoSangre->id ? 'selected' : '' }}>{{ucwords ($tipoSangre->nombre)}}</option>
              @endforeach
            </select>
        ...
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_sede}}">
            ...
            <select id="sede" name="sede" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$sede->id}}" {{ old('sede', $usuario->sede_id)==$sede->id ? 'selected' : '' }}>{{ucwords ($sede->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_tipo_vinculacion}}">
            ...
            <select id="tipo_vinculacion" name="tipo_vinculación" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$tipoDeVinculacion->id}}" {{ old('tipo_vinculación', $usuario->tipo_vinculacion_id)==$tipoDeVinculacion->id ? 'selected' : '' }}>{{ucwords ($tipoDeVinculacion->nombre)}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_informacion_opcional}}">
            ...
            <textarea onkeypress="return sinComillas(event)" id="informacion_opcional" name="información_opcional" class="form-control" rows="5" maxlength="10000" placeholder="">{{ old('información_opcional', $usuario->informacion_opcional) }}</textarea>
          ...
          <div class="mb-2 {{$formulario->class_campo_reservado}}">
            ...
            <textarea onkeypress="return sinComillas(event)" id="campo_reservado" name="campo_reservado" class="form-control" rows="5" maxlength="50000" placeholder="">{{ old('campo_reservado', $usuario->campo_reservado) }}</textarea>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_archivo_a}}">
            ...
            <span id="mensaje_remplazar_archivo_a"><br> Este archivo ya fue adjuntado, ¿Desea remplazarlo?
              <button type="button" class="btn btn-xs btn-danger btn-remplazar-archivo" data-archivo="archivo_a"> Remplazar </button>
            </span>
            @endif

            <input type="file" id="archivo_a" name="archivo_a" class="form-control {{ $usuario->archivo_a!='' ? 'd-none' : '' }}" accept=".gif, .jpg, .png, .jpeg, .pdf">
          ...
          <div class="mb-2 {{$formulario->class_archivo_b}}">
            ...
            <span id="mensaje_remplazar_archivo_b"><br> Este archivo ya fue adjuntado, ¿Desea remplazarlo?
              <button type="button" class="btn btn-xs btn-danger btn-remplazar-archivo" data-archivo="archivo_b"> Remplazar </button>
            </span>
            @endif

            <input type="file" id="archivo_b" name="archivo_b" class="form-control {{ $usuario->archivo_b!='' ? 'd-none' : '' }}" accept=".gif, .jpg, .png, .jpeg, .pdf">
          ...
          <div class="mb-2 {{$formulario->class_archivo_c}}">
            ...
            <span id="mensaje_remplazar_archivo_c"><br> Este archivo ya fue adjuntado, ¿Desea remplazarlo?
              <button type="button" class="btn btn-xs btn-danger btn-remplazar-archivo" data-archivo="archivo_c"> Remplazar </button>
            </span>
            @endif

            <input type="file" id="archivo_c" name="archivo_c" class="form-control {{ $usuario->archivo_c!='' ? 'd-none' : '' }}" accept=".gif, .jpg, .png, .jpeg, .pdf">
          ...
          <div class="mb-2 {{$formulario->class_archivo_d}}">
            ...
            <span id="mensaje_remplazar_archivo_d"><br> Este archivo ya fue adjuntado, ¿Desea remplazarlo?
              <button type="button" class="btn btn-xs btn-danger btn-remplazar-archivo" data-archivo="archivo_d"> Remplazar </button>
            </span>
            @endif

            <input type="file" id="archivo_d" name="archivo_d" class="form-control {{ $usuario->archivo_d!='' ? 'd-none' : '' }}" accept=".gif, .jpg, .png, .jpeg, .pdf">
        ...
        <div class="row">
          ...
          <div class="mb-2 {{$formulario->class_tipo_identificacion_acudiente}}">
            ...
            <select id="tipo_identificacion_acudiente" name="tipo_de_identificación_del_acudiente" class="select2 form-select" data-allow-clear="true">
              <option value="" selected>Ninguno</option>
              @foreach ($tiposIdentificaciones as $tipoIdentificacion)
              <option value="{{$tipoIdentificacion->id}}" {{ old('tipo_de_identificación_del_acudiente', $usuario->tipo_identificacion_acudiente_id)==$tipoIdentificacion->id ? 'selected' : '' }}>{{$tipoIdentificacion->nombre}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-2 {{$formulario->class_identificacion_acudiente}}">
            ...
            <input id="identificacion_acudiente" name="identificación_del_acudiente" value="{{ old('identificación_del_acudiente', $usuario->identificacion_acudiente) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_nombre_acudiente}}">
            ...
            <input id="nombre_acudiente" name="nombre_del_acudiente" value="{{ old('nombre_del_acudiente', $usuario->nombre_acudiente) }}" type="text" class="form-control" />
          ...
          <div class="mb-2 {{$formulario->class_telefono_acudiente}}">
            ...
            <div class="input-group input-group-merge">
              <span id="basic-icon-default-phone2" class="input-group-text"><i class="ti ti-phone"></i></span>
              <input id="telefono_acudiente" name="teléfono_del_acudiente" value="{{ old('teléfono_del_acudiente', $usuario->telefono_acudiente) }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
            </div>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-2 {{$campo->class_col}}">
            ...
            <input id="{{$campo->class_id}}" name="{{$campo->class_id}}" value="{{ old($campo->class_id, $usuario->camposExtras()->where('campos_extra.id', $campo->id)->first() ? $usuario->camposExtras()->where('campos_extra.id', $campo->id)->first()->pivot->valor : '' ) }}" class="form-control">
            @endif
            <!-- /campo tipo 1 -->

            <!-- campo tipo 2 -->
            @if($campo->tipo_de_campo == 2 && $campo->pivot->visible)
            <textarea id="{{$campo->class_id}}" name="{{$campo->class_id}}" class="form-control">{{ old($campo->class_id, $usuario->camposExtras()->where('campos_extra.id', $campo->id)->first() ? $usuario->camposExtras()->where('campos_extra.id', $campo->id)->first()->pivot->valor : '' ) }}</textarea>
            @endif
            <!-- /campo tipo 2 -->
