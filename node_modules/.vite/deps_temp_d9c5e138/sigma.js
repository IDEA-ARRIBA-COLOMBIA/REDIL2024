...
var Sigma$1 = function(_TypedEventEmitter) {
  ...
  _createClass(Sigma2, [{
    ...
    value: function unregisterNodeProgram(key) {
      if (this.nodePrograms[key]) {
        var _this$nodePrograms = this.nodePrograms, program = _this$nodePrograms[key], programs = _objectWithoutProperties(_this$nodePrograms, [key].map(toPropertyKey));
        program.kill();
        this.nodePrograms = programs;
      }
      if (this.nodeHoverPrograms[key]) {
        var _this$nodeHoverProgra = this.nodeHoverPrograms, _program = _this$nodeHoverProgra[key], _programs = _objectWithoutProperties(_this$nodeHoverProgra, [key].map(toPropertyKey));
        _program.kill();
    ...
    value: function unregisterEdgeProgram(key) {
      if (this.edgePrograms[key]) {
        var _this$edgePrograms = this.edgePrograms, program = _this$edgePrograms[key], programs = _objectWithoutProperties(_this$edgePrograms, [key].map(toPropertyKey));
        program.kill();
    ...
    value: function bindEventHandlers() {
      ...
      var createMouseListener = function createMouseListener2(eventType) {
        return function(e) {
          var baseEvent = {
            event: e,
            preventSigmaDefault: function preventSigmaDefault() {
